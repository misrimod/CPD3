...
def generate_html_nav(directory):

    links = []

    for filename in os.listdir(directory):
        if filename.endswith(".html"):
            #create hyperlink with the filename
    ...
    nav_html = f"<nav><details><summary>Meets</summary>\n{links_html}\n</details></nav>"

    return nav_html

dir = os.getcwd()
nav_html_content = generate_html_nav(dir+"/meets")
print(nav_html_content)
